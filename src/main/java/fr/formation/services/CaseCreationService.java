...
public class CaseCreationService {
	...
	public List <Complaint> genererPlaintes() {
		
		List <Complaint> plaintes = new ArrayList<>();
		
		// Première plainte //
		
		Complaint premierePlainte = new Complaint();
		...
		Complaint deuxiemePlainte = new Complaint();
